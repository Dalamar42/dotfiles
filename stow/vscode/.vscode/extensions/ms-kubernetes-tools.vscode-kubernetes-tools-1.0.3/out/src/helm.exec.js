...
function helmInstallCore(kubectl, chartId, version) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const versionArg = version ? `--version ${version}` : '';
        const sr = yield helmExecAsync(`install ${chartId} ${versionArg} ${nsArg}`);
        if (!sr || sr.code !== 0) {
...
function helmServe() {
    return __awaiter(this, void 0, void 0, function* () {
        const configuredBin = config_1.getToolPath(host_1.host, shell_1.shell, 'helm');
        const bin = shell_1.shell.unquotedPath(configuredBin ? `"${configuredBin}"` : "helm");
        const process = child_process_1.spawn(bin, ["serve"]);
        let ready = false;
