...
class JavaDebugProvider {
    ...
    resolvePortsFromFile(dockerfile, env) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            rawAppPortInfo = yield debugUtils.promptForAppPort(possiblePorts, defaultJavaAppPort, env);
            return {
    ...
    resolvePortsFromContainer(kubectl, pod, podNamespace, container) {
        return __awaiter(this, void 0, void 0, function* () {
            let rawDebugPortInfo;
            const commandLines = yield debugUtils.getCommandsOfProcesses(kubectl, pod, podNamespace, container);
