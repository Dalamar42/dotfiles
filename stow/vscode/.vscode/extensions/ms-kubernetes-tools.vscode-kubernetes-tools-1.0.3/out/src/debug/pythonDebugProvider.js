...
class PythonDebugProvider {
    ...
    isDebuggerInstalled() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const answer = yield vscode.window.showInformationMessage(`Pyhon debugging requires the '${defaultPythonDebuggerExtensionId}' extension. Would you like to install it now?`, "Install Now");
