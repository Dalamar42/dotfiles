...
function openDashboardForAKSCluster(kubectl) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const portMapping = port_forward_1.buildPortMapping("9090");
        const boundPort = yield port_forward_1.portForwardToPod(kubectl, dashboardPod, portMapping, 'kube-system');
        setTimeout(() => {
