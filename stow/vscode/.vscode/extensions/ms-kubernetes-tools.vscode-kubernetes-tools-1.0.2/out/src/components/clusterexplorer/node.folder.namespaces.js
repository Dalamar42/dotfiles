...
const node_resource_namespace_1 = require("./node.resource.namespace");
class NamespacesFolder extends node_folder_resource_1.ResourceFolderNode {
    ...
    getChildren(kubectl, _host) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return namespaces.map((ns) => new node_resource_namespace_1.NamespaceResourceNode(this.kind, ns.name, ns));
        });
    }
}
