    ...
    return __awaiter(this, void 0, void 0, function* () {
        if (explorerNode) {
            ...
            if (result && result.code === 0) {
                describeWebview_1.DescribePanel.createOrShow(result.stdout, explorerNode.resourceId, refresh);
            }
            else {
...
const debugAttachKubernetes = (explorerNode) => __awaiter(this, void 0, void 0, function* () {
    const workspaceFolder = yield hostutils_1.showWorkspaceFolderPick();
    if (workspaceFolder) {
        new debugSession_1.DebugSession(kubectl).attach(workspaceFolder, explorerNode ? explorerNode.id : undefined, explorerNode ? explorerNode.namespace || undefined : undefined); // TODO: rationalise the nulls and undefineds
    }
});
